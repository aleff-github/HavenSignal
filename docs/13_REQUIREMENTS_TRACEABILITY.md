...
| SEC-DEL-001..006 | CRITICAL/HIGH | 03 Lifecycle; 04 Cryptographic Model; 32 Retention/Deletion | 14/32: inert operator order plus key destruction/restore, deletion state/race, blob retry tests | Exact OPEN-only operator order modeled non-authorizing with unavailable executor; legal/review, persistence, audit, MFA, alert, and Key Service gates OPEN CRITICAL |
...
| SEC-RESPONSE-002..008 | CRITICAL | 04 Cryptographic Model; 05 Recovery Response; 24 Response Crypto Protocol; 32 Retention | 14/24/32: AEAD/context, Response-DEK lifecycle/restore, read/unread expiry races | Exact 90-day/72-hour boundaries modeled by an inert non-authorizing planner; persistence, concurrency, legal/review and Key Service gates OPEN |
