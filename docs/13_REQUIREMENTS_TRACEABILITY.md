...
| SEC-LOG-001..004 | CRITICAL | 08 Audit Logging; 15 Trust Boundaries; 20 Submission Protocol; 23 Audit Receipt Protocol | 14: audit failure, durability, privilege, and inert submission-audit phase/payload source-conformance tests | Exact construction owner-approved; inert submission-audit phase and payload profile guarded; independent review and production gates OPEN |
...
| SEC-LOG-009..012 | CRITICAL | 03 Lifecycle; 08 Audit Logging; 20 Submission Protocol; 23 Audit Receipt Protocol | 14: receipt, replay, concurrency, truncation, cessation, crash, submission-audit sequencing, and exact-source tests | Inert replay/claim and submission-audit phase/payload shape checks plus non-executing source conformance implemented; no CBOR/COSE verification, append, receipt creation, authorization, or production capability |
