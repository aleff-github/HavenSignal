...
| SEC-RECOVERY-001..004 | CRITICAL | 05 Recovery Response; 20 Submission Protocol; 21 Recovery Credential Construction | 14: recovery enumeration/secret-handling tests plus inert attempt-credential, duplicate/retry no-redisplay, credential-shape, HMAC-message, recovery failure, recovery key lifecycle, recovery verification, recovery verifier-record, and one-time credential-response source-conformance tests | Owner-approved attempt-credential boundaries, duplicate/retry no-redisplay outcomes, recovery credential shapes, HMAC-message layout, recovery failure behavior, Recovery Verifier key lifecycle, verification, and persisted-record metadata, and one-time response/lost-response policy have content-free Stage A descriptors and exact source guards; generation, verifier execution, lookup, persistence, endpoint, independent cryptographic review, and dependent gates remain OPEN |
| SEC-RECOVERY-005 | CRITICAL | 05 Recovery Response; 12 Open Decisions; 21 Recovery Credential Construction | Owner decision, inert HMAC-message/recovery verification/verifier-record source-conformance tests, and independent cryptographic design review | Owner-approved HMAC framing, verifier semantics, and record shape are represented inertly; independent review required before implementation |
