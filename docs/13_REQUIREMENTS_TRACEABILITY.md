...
| SEC-FILE-001..003 | CRITICAL | 07 File Security; 15 Trust Boundaries; 29 File/Sandbox | 14/29: profile, parser differential, microVM, CDR and access tests plus inert descriptor source-conformance tests | Common attachment count/size/kind/slot/trust-denial profile modeled inertly; parser, sandbox, safe-view, encryption, endpoint, independent review, and production gates OPEN |
| SEC-FILE-004..006 | HIGH | 07 File Security; 12 Open Decisions; 29 File/Sandbox | 14/29: plaintext lifecycle, resource, corpus, teardown tests plus inert descriptor source-conformance tests | Exact common admission profile is source-guarded; artifact pinning, parser/sandbox implementation, and production validation OPEN |
