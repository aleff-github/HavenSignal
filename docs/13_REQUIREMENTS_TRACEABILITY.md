...
| SEC-CAPTCHA-004 | CRITICAL | 10 Network Anonymity | 14: dependency-failure and negative-capability source tests | Unavailable adapter/error source locked to deny without fallback; mandatory flow and production proof remain absent |
