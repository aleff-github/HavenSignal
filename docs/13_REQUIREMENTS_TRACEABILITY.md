...
| SEC-ANON-001..003 | CRITICAL | 00 Scope; 05 Recovery; 08 Audit; 10 Network Anonymity; 20 Submission Protocol | 14: reporter logging, recovery enumeration, browser caching, and inert attempt-credential source-conformance tests | Attempt-credential account/network/content binding denials are content-free and source-guarded; endpoint/logging/deployment validation remains required |
...
| SEC-ANON-006..007 | HIGH | 10 Network Anonymity; 16 Django Rules; 34 Pre-Code Gate | 14: inert surface source policy plus UI/deployment review | Current passive template/CSS, single-route, read-only-view, and restrictive-header-middleware executable profiles enforced statically; browser and deployment proof remain OPEN |
