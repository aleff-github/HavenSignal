...
| SEC-LOG-001..004 | CRITICAL | 08 Audit Logging; 15 Trust Boundaries; 20 Submission Protocol; 23 Audit Receipt Protocol | 14: audit failure, durability, privilege, inert submission-audit phase/payload, and inert reconciliation source-conformance tests | Exact construction owner-approved; inert submission-audit and reconciliation metadata profiles guarded; independent review and production gates OPEN |
...
| SEC-LOG-009..012 | CRITICAL | 03 Lifecycle; 08 Audit Logging; 20 Submission Protocol; 23 Audit Receipt Protocol | 14: receipt, replay, concurrency, truncation, cessation, crash, duplicate/retry outcome, submission-audit sequencing, reconciliation, and exact-source tests | Inert replay/claim, duplicate/retry outcome, submission-audit phase/payload, and reconciliation timing/action shape checks plus non-executing source conformance implemented; no CBOR/COSE verification, append, receipt creation, service call, authorization, or production capability |
