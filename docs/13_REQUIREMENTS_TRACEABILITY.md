...
| SEC-RECOVERY-001..004 | CRITICAL | 05 Recovery Response; 20 Submission Protocol; 21 Recovery Credential Construction | 14: recovery enumeration/secret-handling tests plus inert attempt-credential, duplicate/retry no-redisplay, credential-shape, HMAC-message, recovery failure, recovery key lifecycle, recovery verification, recovery verifier-record/service, recovery eligibility, and one-time credential-response source-conformance tests | Owner-approved attempt-credential boundaries, duplicate/retry no-redisplay outcomes, recovery credential shapes, HMAC-message layout, recovery failure behavior, Recovery Verifier key lifecycle, verification, persisted-record, service-operation, and eligibility metadata, and one-time response/lost-response policy have content-free Stage A descriptors and exact source guards; generation, verifier execution, lookup, persistence, endpoint, independent cryptographic review, and dependent gates remain OPEN |
...
| SEC-RESPONSE-002..008 | CRITICAL | 04 Cryptographic Model; 05 Recovery Response; 21 Recovery Credential Construction; 24 Response Crypto Protocol; 32 Retention | 14/21/24/32: AEAD/context, Response-DEK lifecycle/restore, recovery failure, recovery key lifecycle, read/unread expiry races plus inert eligibility descriptor source-conformance tests | Exact 90-day/72-hour inert planner plus content-free response crypto/schema, recovery failure, recovery key-lifecycle, and recovery eligibility profile descriptors with their non-executing source profiles are enforced; canonicalization, CBOR encoding/parsing, encryption/decryption, persistence, concurrency, legal/review and Key Service gates OPEN |
