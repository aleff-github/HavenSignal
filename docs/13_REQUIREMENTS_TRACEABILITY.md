...
| SEC-ACCESS-011..015 | CRITICAL | 03 Lifecycle; 06 Operator Sessions; 16 Django Rules; 34 Pre-Code Gate | 14: lease generation, stale request, constraint tests | Metadata-only Stage A schema/planners implemented; reviewed persistence executor and PostgreSQL concurrency proof remain OPEN |
