...
| SEC-RECOVERY-001..004 | CRITICAL | 05 Recovery Response; 20 Submission Protocol; 21 Recovery Credential Construction | 14: recovery enumeration/secret-handling tests plus inert attempt-credential, duplicate/retry no-redisplay, credential-shape, HMAC-message, recovery failure, recovery key lifecycle, recovery verification, recovery verifier-record/service, and one-time credential-response source-conformance tests | Owner-approved attempt-credential boundaries, duplicate/retry no-redisplay outcomes, recovery credential shapes, HMAC-message layout, recovery failure behavior, Recovery Verifier key lifecycle, verification, persisted-record, and service-operation metadata, and one-time response/lost-response policy have content-free Stage A descriptors and exact source guards; generation, verifier execution, lookup, persistence, endpoint, independent cryptographic review, and dependent gates remain OPEN |
| SEC-RECOVERY-005 | CRITICAL | 05 Recovery Response; 12 Open Decisions; 21 Recovery Credential Construction | Owner decision, inert HMAC-message/recovery verification/verifier-record/service source-conformance tests, and independent cryptographic design review | Owner-approved HMAC framing, verifier semantics, record shape, and service operation boundary are represented inertly; independent review required before implementation |
...
| SEC-RESPONSE-002..008 | CRITICAL | 04 Cryptographic Model; 05 Recovery Response; 21 Recovery Credential Construction; 24 Response Crypto Protocol; 32 Retention | 14/21/24/32: AEAD/context, Response-DEK lifecycle/restore, recovery failure, recovery key lifecycle, read/unread expiry races plus inert descriptor source-conformance tests | Exact 90-day/72-hour inert planner plus content-free response crypto/schema, recovery failure, and recovery key-lifecycle profile descriptors with their non-executing source profiles are enforced; canonicalization, CBOR encoding/parsing, encryption/decryption, persistence, concurrency, legal/review and Key Service gates OPEN |
