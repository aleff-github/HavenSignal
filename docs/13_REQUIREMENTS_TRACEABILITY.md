...
| SEC-ACCESS-011..015 | CRITICAL | 03 Lifecycle; 06 Operator Sessions; 16 Django Rules; 34 Pre-Code Gate | 14: lease generation, stale/cross-binding request, constraint and 20–100 contender tests | Metadata-only schema/planners/bindings plus inert synthetic test plan implemented; persistence and concurrency runner remain fail-closed, with PostgreSQL executor/proof OPEN |
