...
|---|---|---|---|---|
| SEC-CONF-001..008 | CRITICAL | 02 Threat Model; 04 Cryptographic Model; 15 Trust Boundaries; 20 Submission Protocol; 26 Report Crypto | 14: AEAD/context, key destruction, roles/capabilities, deployment checks plus inert report text/frame/crypto/schema descriptor source-conformance tests | Exact report crypto owner-approved and content-free Stage A text/frame/crypto/schema descriptors with source guards implemented; independent review and Key Service gates OPEN |
...
| SEC-LOG-009..012 | CRITICAL | 03 Lifecycle; 08 Audit Logging; 20 Submission Protocol; 23 Audit Receipt Protocol | 14: receipt, replay, concurrency, truncation, cessation, crash, duplicate/retry outcome, submission-audit sequencing, acceptance checkpoints, reconciliation, and exact-source tests | Inert replay/claim, duplicate/retry outcome, submission-audit phase/payload, acceptance-checkpoint, and reconciliation timing/action shape checks plus non-executing source conformance implemented; no CBOR/COSE verification, append, receipt creation, service call, authorization, or production capability |
...
| SEC-RECOVERY-001..004 | CRITICAL | 05 Recovery Response; 20 Submission Protocol; 21 Recovery Credential Construction | 14: recovery enumeration/secret-handling tests plus inert attempt-credential, duplicate/retry no-redisplay, credential-shape, and one-time credential-response source-conformance tests | Owner-approved attempt-credential boundaries, duplicate/retry no-redisplay outcomes, recovery credential shapes, and one-time response/lost-response policy have content-free Stage A descriptors and exact source guards; generation, verifier, lookup, persistence, endpoint, independent cryptographic review, and dependent gates remain OPEN |
...
| SEC-RESPONSE-002..008 | CRITICAL | 04 Cryptographic Model; 05 Recovery Response; 24 Response Crypto Protocol; 32 Retention | 14/24/32: AEAD/context, Response-DEK lifecycle/restore, read/unread expiry races plus inert descriptor source-conformance tests | Exact 90-day/72-hour inert planner plus content-free response crypto/schema profile descriptors and their non-executing source profiles are enforced; canonicalization, CBOR encoding/parsing, encryption/decryption, persistence, concurrency, legal/review and Key Service gates OPEN |
