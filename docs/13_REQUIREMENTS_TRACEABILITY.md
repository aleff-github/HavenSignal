...
| SEC-ACCESS-011..015 | CRITICAL | 03 Lifecycle; 06 Operator Sessions; 16 Django Rules; 34 Pre-Code Gate | 14: lease generation, stale/cross-binding request, constraint tests | Metadata-only schema/planners/binding validators implemented; persistence remains fail-closed and PostgreSQL executor/concurrency proof remain OPEN |
...
| SEC-ROLE-001..003 | CRITICAL | 02 Threat Model; 15 Trust Boundaries; 19 Interfaces; 33 Operational Access | 14/33: cross-role device/network/credential/capability tests | Inert Reporter/URL source-import allowlists implemented; physical, credential, network, runtime, and production proof OPEN |
