...
| Security Workflow Coordinator | Audit Collector | Obtain required receipts and append truthful outcomes | Receipt/checkpoint construction OPEN CRITICAL |
...
| Emergency Export Worker | Audit Collector | Obtain the export pre-action receipt and append truthful outcome | Receipt/checkpoint construction OPEN CRITICAL |
...
| Audit Collector | Independent checkpoint verifier | Publish independently verifiable evidence | Construction and cadence OPEN CRITICAL |
