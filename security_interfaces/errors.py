...
class RecoveryFailureDescriptorRejected(ValueError):
    ...
    public_code = "recovery_failure_descriptor_rejected"
...
class RecoveryVerificationDescriptorRejected(ValueError):
    """Controlled rejection for invalid inert recovery verification metadata."""

    public_code = "recovery_verification_descriptor_rejected"

    def __init__(self) -> None:
        super().__init__(self.public_code)


class RecoveryVerifierRecordDescriptorRejected(ValueError):
    """Controlled rejection for invalid inert recovery verifier record metadata."""

    public_code = "recovery_verifier_record_descriptor_rejected"

    def __init__(self) -> None:
        super().__init__(self.public_code)


class RecoveryVerifierServiceDescriptorRejected(ValueError):
    """Controlled rejection for invalid inert recovery verifier service metadata."""

    public_code = "recovery_verifier_service_descriptor_rejected"

    def __init__(self) -> None:
        super().__init__(self.public_code)


class RecoveryEligibilityDescriptorRejected(ValueError):
    """Controlled rejection for invalid inert recovery eligibility metadata."""

    public_code = "recovery_eligibility_descriptor_rejected"
