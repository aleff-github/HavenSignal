...
FORBIDDEN_TRACKED_PATH_PATTERNS = (
    ...
    (".docker/secrets/*", "SECRET_DIRECTORY"),
    ("*.pem", "SECRET_MATERIAL"),
    ("*.key", "SECRET_MATERIAL"),
    ("*.p12", "SECRET_MATERIAL"),
    ("*.pfx", "SECRET_MATERIAL"),
    ("AGENTS.md", "LOCAL_DEVELOPMENT_INSTRUCTION"),
    ("START-CODEX.md", "LOCAL_DEVELOPMENT_INSTRUCTION"),
    ("docs/CODEX_USAGE.md", "LOCAL_DEVELOPMENT_INSTRUCTION"),
    (".codex/*", "LOCAL_DEVELOPMENT_INSTRUCTION"),
    ("resume", "LOCAL_SESSION_ARTIFACT"),
